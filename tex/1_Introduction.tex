...
\noindent\fbox{
	\parbox{\textwidth}{
		\textbf{RQ:} Is it possible to assess the safety of CPSs by learning the patterns of system violation properties, while accounting for the complexity of the physical-behavioral interactions inherent of such systems?
	}
}
\vspace{0.3 cm}
